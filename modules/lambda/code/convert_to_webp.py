    ...
    for record in event['Records']:
        try:
            ...
            if image.format == 'WEBP':
                logger.info("Image is already in WEBP")
            ...
            blob_client = blob_service_client.get_blob_client(container=os.environ['AZURE_CONTAINER_NAME'], blob=f'webp/{image_id}.webp')
            ...
            dynamodb.update_item(
                ...
                UpdateExpression="SET azure_webp_key = :webp",
                ExpressionAttributeValues={':webp': {'S': 'webp/'+image_id+'.webp'}}
            )
